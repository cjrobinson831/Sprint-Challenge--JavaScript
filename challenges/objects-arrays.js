...
const uni = [];
for (let i = 0; i < uni.university; i++) {
  if(uni[i] === "university") {
...
const largerPopulation = animal.filter((population) => {
  return largerPopulation.population < "5";
});
...
const populationTotal = animals.reduce((populationTotal, populationAmount) => {
